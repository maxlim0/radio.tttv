...
<!--	<script type='text/javascript' src="js/flexticker.js"></script> -->
...
<body>
 <div id="main">
	<!-- <div id="header">
            ...
            <div id="inform">
				<?php if($view_user == 1){
						echo '<a class="right_reg" id="out_client_chat" href="#">Выход</a>  
						 <a class="right_reg" id="online_client_chat" href="#">on-Line</a>';
					}else{
		...
		<script type="text/javascript" src="http://teletrade.tv/robot/js/tmpl=image/get=anons_robot/width=640/height=183/color_top=ffffff/color_border=ffffff/color_bg=ffffff/color_bg_top=ffffff/color_bottom=ffffff"></script>
	...
	<div class="cl"></div>
				<?php 
						...
						<div class='title_us'>Управление пользователями
							<a href='#' id='add_client_chat_us'>
							<img src='images/reportplus.png' /></a>
								<a href='#' id='add_closed_conference'>
							...
							<div class='container_us'>
								<div id='content_us'>";
										$v_user = new BoardView();
											echo'<table class="tablesorter"  id="table_us" width="1040" border="0" cellpadding="5" cellspacing="2">
											<thead>
											  <tr class="tabluser_view_top">
												<th align="center" width="150">Логин</th>
												<th align="center" width="150">ФИО</th>
												<th align="center" width="70">Телефон</th>
												<th align="center" width="100">Пароль</th>
												<th align="center" width="100">E-mail</th>
												<th align="center" width="150">Дата регистрации</th>
												<th align="center" width="150">Дата последнего входа</th>
												<th align="center" width="80">Статус</th>
												<th align="center" width="40">Закр конф.</th>
												<th align="center" width="30"><img src="images/edit.png" /></th>
												<th align="center" width="30"><img src="images/cross.png" /></th>
												</tr></thead><tbody>';
											  echo $v_user->ViewUsers();
											  unset($v_user);
									echo"</tbody></table>
								</div>
							</div>
